...
export default function Quote() {
  ...
  function sendQuoteRequest(event) {
    ...
    setSubmitted(true)
    window.location.href = `mailto:info@cleanqueens.net?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
  }
      ...
      <section className="quote-section">
        <div className="quote-shell quote-layout">
          ...
          <aside className="quote-contact">
            ...
            <p><strong>Email</strong><a href="mailto:info@cleanqueens.net">info@cleanqueens.net</a></p>
